...
const VehicleManagement = () => {
  ...
  const [formData, setFormData] = useState({ make: '', model: '', coding_sched: '', plate: '', seaters: '' });
  ...
  const validateForm = () => {
    ...
    if (!formData.coding_sched?.trim()) {
      newErrors.coding_sched = 'Coding schedule is required';
    }
  ...
  const handleConfirmUpdate = async () => {
    try {
      const vehicleData = {
        ...
        coding_sched: formData.coding_sched,
      ...
      await fetchVehicles();
      setEditingId(null);
      setFormData({ make: '', model: '', coding_sched: '', plate: '', seaters: '' });
      setErrors({});
    } catch (error) {
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                <div>
                  ...
                  <input
                    ...
                    className={`w-full px-3 py-2 border rounded-md focus:ring-2 focus:ring-blue-500 focus:border-blue-500 ${errors.make ? 'border-red-500' : 'border-gray-300'
                      }`}
                  />
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={handleInputChange}
                    className={`w-full px-3 py-2 border rounded-md focus:ring-2 focus:ring-blue-500 focus:border-blue-500 ${errors.model ? 'border-red-500' : 'border-gray-300'
                      }`}
                  />
                ...
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-1">
                    Coding Sched <span className="text-red-600">*</span>
                  </label>
                  <select
                    name="coding_sched"
                    value={formData.coding_sched}
                    onChange={handleInputChange}
                    className={`w-full px-3 py-2 border rounded-md focus:ring-2 focus:ring-blue-500 focus:border-blue-500 ${errors.coding_sched ? 'border-red-500' : 'border-gray-300'
                      }`}
                  >
                  ...
                  {errors.coding_sched && <p className="text-red-600 text-xs mt-1">{errors.coding_sched}</p>}
                </div>
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-1">
                  ...
                  <input
                    ...
                    onChange={handleInputChange}
                    className={`w-full px-3 py-2 border rounded-md focus:ring-2 focus:ring-blue-500 focus:border-blue-500 ${errors.plate ? 'border-red-500' : 'border-gray-300'
                      }`}
                  />
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={handleInputChange}
                    className={`w-full px-3 py-2 border rounded-md focus:ring-2 focus:ring-blue-500 focus:border-blue-500 ${errors.seaters ? 'border-red-500' : 'border-gray-300'
                      }`}
                  />
        ...
        {loading ? (
          ...
          <div className="overflow-hidden">
            <div className="hidden md:grid md:grid-cols-12 gap-4 px-6 py-3 bg-gray-100 border-b border-gray-200 font-semibold text-sm text-gray-700">
              ...
              <div className="md:col-span-2">
                <SortableHeader label="Coding Sched" sortKey="coding_sched" />
              </div>
              <div className="md:col-span-2">
                ...
                return (
                  <div key={vehicle.id} className="hover:bg-gradient-to-r hover:from-blue-50 hover:to-transparent transition-colors">
                    ...
                    <div className="hidden md:grid md:grid-cols-12 gap-4 px-6 py-4 items-center">
                      ...
                      <div className="md:col-span-2">
                        <p className="text-gray-700 font-medium">{vehicle.coding_sched}</p>
                      </div>
                      <div className="md:col-span-2">
                      ...
                      <div className="flex items-start justify-between">
                        <div className="flex items-start space-x-3 flex-1">
                          ...
                          <div className="flex-1">
                            ...
                            <p className="text-sm text-gray-500 mt-1">
                              Coding Sched: <span className="font-medium text-gray-700">{vehicle.coding_sched}</span>
                            </p>
                            <p className="text-sm text-gray-500 mt-1">
          ...
          <div className="bg-white rounded-2xl shadow-2xl max-w-md w-full transform transition-all">
            <div className="p-8 text-center">
              <div className="flex items-center justify-center w-16 h-16 mx-auto rounded-full mb-6 ${
                ...
                <Info className={`h-8 w-8 ${confirmModal.action === 'delete'
                  ? 'text-red-600'
                  : 'text-blue-600'
                  }`} />
              </div>
            ...
            <div className="bg-gray-50 px-8 py-6 flex gap-3 rounded-b-2xl">
              ...
              <button
                ...
                className={`flex-1 px-4 py-3 text-white font-medium rounded-lg transition-colors ${confirmModal.action === 'delete'
